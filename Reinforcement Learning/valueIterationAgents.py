                ...
                if (not self.mdp.isTerminal(state)):
                    ...
                    for action in possibleActions:
                        ...
                        for transition in transitions:
                            value += transition[1] * (self.mdp.getReward(state, action, transition[0]) + self.discount *
                                                      currentValue[transition[0]])
